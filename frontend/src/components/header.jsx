    ...
    return (
        <header className="z-1000 w-full">
            <div className="flex-wrap flex p-[30px]">
                <img src={logo} alt="Rescrub" className="md:hidden"/>
                <div className="cursor-pointer ml-auto md:ml-0 md:mr-auto">
                    <svg height="20" width="21" fill="none" viewBox="0 0 21 20" xmlns="http://www.w3.org/2000/svg" className="text-black transition-colors duration-200 hover:text-main">
